...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file blink.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=cortex/armv7em/stm32f407/stm32f4discovery --templates=../../../../../../goil/templates/ blink.oil")
	sys.exit(1)
...
oilCompiler = "goil"
oilFlags = ["-t=cortex/armv7em/stm32f407/stm32f4discovery", "--templates=../../../../../../goil/templates/"]
...
#--- Add generated files
sourceList.append("blink/tpl_app_config.c")

sourceList.append("blink/tpl_dispatch_table.c")
sourceList.append("blink/tpl_invoque.S")
sourceList.append("blink/tpl_primary_irq.S")
sourceList.append("blink/tpl_vectors.c")
sourceList.append("blink/tpl_external_interrupts.c")
sourceList.append("blink/tpl_app_interrupts.c")
