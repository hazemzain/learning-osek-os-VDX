...
#--- automatically generated by goil on Mon Oct 23 22:18:29 2023
...
includeDirs += ["-I","../../../../../../machines/cortex/armv7em/stm32f407"]
includeDirs += ["-I","../../../../../../machines/cortex/armv7em/stm32f407/lib"]
includeDirs += ["-I","../../../../../../machines/cortex/armv7em/stm32f407/CMSIS-ST/Device/ST/STM32F4xx/Include"]
includeDirs += ["-I","../../../../../../machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver"]
includeDirs += ["-I","../../../../../../machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver"]
includeDirs += ["-I","../../../../../../machines/cortex/armv7em/stm32f407/stm32f4discovery"]
if with_ioc:
  includeDirs += ["-I", "../../../../../../ioc"]
includeDirs += ["-I", "../../../../../../os"]
includeDirs += ["-I", "../../../../../../debug"]
...
cSourceList.append(projfile.ProjectFile("blink/tpl_app_interrupts.c"))
...
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/tpl_memory_protection.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/tpl_machine_stm32f407.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/startup_stm32f4xx.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/system_stm32f4xx.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/handlers_stm32f4xx.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/lib/pinAccess.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/stm32f4xx_gpio.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/stm32f4xx_rcc.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/stm32f4xx_exti.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/stm32f4xx_syscfg.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver/misc.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/stm32f4discovery/stm32f4_discovery.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex/armv7em/stm32f407/stm32f4discovery/tp.c", trampoline_base_path))
#----------------------------------------------------------------------
...
if True:
  postCommand = makefile.PostCommand("Generating binary blink_exe.bin from blink_exe")
  postCommand.mCommand.append(r"arm-none-eabi-objcopy")
  postCommand.mCommand += "-O binary".split()
  postCommand.mCommand.append("blink_exe")
  postCommand.mCommand.append("blink_exe.bin")
...
postVariableMapping = dict(
  ...
  ARCH_PATH='../../../../../../machines/cortex',
  BOARD_PATH='../../../../../../machines/cortex/armv7em/stm32f407/stm32f4discovery',
  TARGET='cortex/armv7em/stm32f407/stm32f4discovery'
)
...
if make.errorCount() == 0:
  if askedGoal == "burn" :
    ...
    if makefile.find_executable("st-flash") != None:
      print("\033[1m\033[95mFlashing blink_exe on cortex/armv7em/stm32f407/stm32f4discovery\033[0m")
